...
export const autonomous: Theme = {
  ...
  layers: [
    ...
    },
    {
      ...
      stocks: [
        /*
         * 루미나 테크놀로지스(LAZR)가 이 층의 대장주였습니다. 회사가 없어졌고,
         * 비어 있던 티커는 2026-06-30 부터 **Tema Photonics ETF** 가 쓰고
         * 있습니다. 야후가 이것도 정상 종목으로 응답해 티커 생존 검사에는
         * 안 걸렸습니다(`npm run namuh` 가 잡았습니다).
         *
         * 대장주 자리는 OUST 로 넘깁니다. 남은 둘 중 라이다 매출이 실제로
         * 나오고 있는 쪽입니다.
         */
        {
          ticker: "OUST",
