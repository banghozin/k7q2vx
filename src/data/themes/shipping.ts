  ...
  layers: [
    ...
    },
    {
      ...
      stocks: [
        ...
        /*
         * 골든 오션 그룹(GOGL)이 여기 있었습니다. 2025년 CMB.TECH 에 합병돼
         * 사라졌고, 비어 있던 GOGL 티커는 2026-06-26 부터 **구글 2배 레버리지
         * ETF** 가 쓰고 있습니다. 야후는 이것도 정상 종목으로 응답해서
         * 티커 생존 검사에 걸리지 않았습니다(`npm run namuh` 가 잡았습니다).
         *
         * 승계 회사인 CMB.TECH(CMBT)로 갈아끼우지 않은 이유: 합병 뒤 벌크선
         * 89척에 유조선·화학운반선·컨테이너선·해상풍력 작업선까지 250척을
         * 굴리는 회사가 됐습니다. **이 층 저 층에 다 걸쳐 있어 "왜 이 층인가"
         * 를 한 줄로 쓸 수 없습니다.** 그런 종목을 넣으면 층이 흐려집니다.
         */
        {
          ticker: "GNK",
          name: "젠코 시핑 앤 트레이딩",
